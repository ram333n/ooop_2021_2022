...
TEST_CASE("Matrix multiplication") {
	...
	SUBCASE("Strassen single threaded") {
		auto res_1 = Matrix::StrassenAlgorithm(lhs_1, rhs_1);
		auto res_2 = Matrix::StrassenAlgorithm(lhs_2, rhs_2);
		auto res_3 = Matrix::StrassenAlgorithm(lhs_3, rhs_3);
		auto res_4 = Matrix::StrassenAlgorithm(lhs_4, rhs_4);
		auto res_5 = Matrix::StrassenAlgorithm(lhs_5, rhs_5);
